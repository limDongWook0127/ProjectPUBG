...
void APUBGCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void APUBGCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APUBGCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
